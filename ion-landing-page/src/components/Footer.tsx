...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#050505] pt-20 pb-10 border-t border-white/5 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-violet-600/5 blur-[120px] rounded-t-full pointer-events-none" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-16">
          ...
          <div className="md:col-span-4 lg:col-span-5 flex flex-col items-start">
            ...
            <div className="flex items-center gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-violet-500/20 hover:border-violet-500/50 transition-all duration-300">
              ...
              <a href="mailto:contato@lattech.com.br" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-violet-500/20 hover:border-violet-500/50 transition-all duration-300">
          ...
          <div className="md:col-span-2 lg:col-span-3">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="https://wa.me/5541995707907" target="_blank" rel="noopener noreferrer" className="text-sm text-violet-400 hover:text-violet-300 transition-colors font-semibold">
                  +55 (41) 99570-7907
                </a>
              </li>
              <li>
