        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-16">
          ...
          <div className="md:col-span-4 lg:col-span-5 flex flex-col items-start">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/lattechapp/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all duration-300">
          ...
          <div className="md:col-span-2 lg:col-span-3">
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="https://wa.me/5541999564767" target="_blank" rel="noopener noreferrer" className="text-sm text-white hover:text-gray-300 transition-colors font-semibold">
                  +55 (41) 99956-4767
                </a>
              </li>
              <li>
